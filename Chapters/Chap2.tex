...
Taking into account the last shown, a fluid in motion of density $\rho$ subjected to 
...
to know its properties. It is usually considered for the initial density field, that density contrasts 
...
is the phase and varies between $[0,2\pi)$.  The joint probability distribution function is useful because it allows the independence of the terms $\delta_{\mbox{\boldmath$\kappa$}}$, or in other words it is the product of every mode
...
all  possible orientations of the vector ${\mbox{\boldmath$\kappa$}}$, as it can be seen in the expression. 
...
It is necessary to consider that after recombination epoch, density contrasts started growing in size 
