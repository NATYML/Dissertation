...
The initial position of the BAO depends on the sound horizon scale as shown in \ref{SH},
...
Now, the right figure of \ref{prop2} shows the position of the BAO vs the halo mass.
...
In the figure \ref{sigm2}, it is not recovered the same behavior as \ref{sigm1}.
