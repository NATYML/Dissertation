...
During this chapter the questions initially stated are going to be studied in detail, 
...
should be less prominent. In the table \ref{z1}, we show the halo populations used 
...
\begin{center}
  \begin{tabular}{ | c | c | c | }
    ...
    4 & $ M \geqslant 1\times 10^{14}$ & 32436 \\ \hline
    3 & $ 1\times 10^{13} \leq M < 1\times 10^{14} $ & 443356\\ \hline
    2 & $ 1\times 10^{12} \leq M < 1\times 10^{13}$ & 3687677\\ \hline
    1 & $ 1\times 10^{11} \leq M < 1\times 10^{12}$ & 32868688 \\ \hline
  \end{tabular}  
...
\begin{center}
  \begin{tabular}{ | c | c | c | }
    ...
    9 & $ 1\times 10^{13.5}$ & 8462\\ \hline
    8 & $ 1\times 10^{13}$ & 66473 \\ \hline
    7 & $ 1\times 10^{12.5}$ & 326163 \\ \hline
    6 & $ 1\times 10^{12}$ & 1258759 \\ \hline
    5 & $ 1\times 10^{11.5}$ & 4333890 \\ \hline
  \end{tabular}  
...
To compute the correlation function was implemented a parallel C code 
that uses MPI.
...
computed. The correlation function was estimated using the LS estimator
shown in the section \ref{STM}.

Next, in the figure \ref{pophalos}, the correlation function for every population 
...
shape and there is a bump around $\sim 105$ $Mpc/h$ that corresponds
to the BAO peak. 
...
in the figure \ref{CFscat}. In this case, for a thick population, $10^{14.5}$ $M_{\odot}/h$
...
mean of the realizations. The xrange was reduced to see in more detail the
bump of the BAO. The dispersion of the CFs values for the two $N_r$ values
...
Something to highlight is that in the population $q_2$ de $1\times 10^{12}$ $M_{\odot}/h$ 
...
with the parameters found. It can be noticed a good coincidence between 
...
\begin{figure}[h]
  ...
  %\end{center}
   \caption{\small 
   Figure with population $1e11$ has a mean of $519.51$ and it's estimated variance is $67214$. 
   Figure with population $1e13$ has a mean of $501.81$ and it's estimated variance is $58720$. 
   Figure with population $1e14$ has a mean of $490.21$ and it's estimated variance is $53063$. 
...
effects are less prominent in this epoch. Similarly, the dashed red line displays
...
for masses lger than $\sim 10^{12.4}$ $M_{\odot}/h$, we recovered the expected tendency. But for
