...
\begin{center}
  \begin{tabular}{ | c | c | c | c | c |  }
    \hline \hline
Mean mass [$M_{\odot}/h$] & $q_1$  & $q_2$  & $q_3$  & $q_4$  \\ \hline
    Pop 1 & $10^{11.77}$ & $10^{11.39}$ & $10^{11.19}$ & $10^{11.06}$ \\ \hline
    Pop 2 & $10^{12.75}$ & $10^{12.39}$ & $10^{12.19}$ & $10^{12.06}$\\ \hline
  \end{tabular}  
   \caption{ Populations constructed from MDPL halo catalogue for z=0. }
\label{pophalos}
\end{center}
...
the coupling among different density modes becomes more notorious.
